...
function sumArray(testArray) { //eslint-disable-line
  var newArray = [];
  newArray[0] = sum(sum(testArray[0], testArray[1])[0], testArray[2])[0];
  newArray[1] = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + newArray[0] + ' is their sum.';
...
function multiplyArray(testArray) { //eslint-disable-line
  var newArray = [];
  newArray[0] = multiply(multiply(testArray[0], testArray[1])[0], testArray[2])[0];
  newArray[1] = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + newArray[0] + '.';
  //console.log(newArray);
  return newArray;
}
